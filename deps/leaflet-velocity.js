...
L.Control.Velocity = L.Control.extend({
  ...
  _onMouseMove: function _onMouseMove(e) {
    ...
    if (gridValue && !isNaN(gridValue[0]) && !isNaN(gridValue[1]) && gridValue[2]) {
      ...
      htmlOut = "<strong> ".concat(this.options.velocityType, " ").concat(this.options.speedString, ": </strong> ").concat(self.vectorToSpeed(gridValue[0], gridValue[1], this.options.speedUnit).toFixed(2), " ").concat(this.options.speedUnit);
    } else {
